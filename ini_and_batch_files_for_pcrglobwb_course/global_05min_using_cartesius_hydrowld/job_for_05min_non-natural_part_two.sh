...
python parallel_pcrglobwb_runner.py /home/edwinwri/PCR-GLOBWB_input_example/ini_and_batch_files_for_pcrglobwb_course/global_05min_using_cartesius_hydrowld/setup_05min_non-natural_part_two.ini
